...
def load_data(data_path, reverse):
    with open(data_path, 'r', encoding='utf-8') as inp_:
        ...
        for i in data:
            ...
            rel_type = int(RELATION_DICT[i[1]])
    return new_data
...
for node in KG.nodes:
    ...
    # For genre, language or year entity types, add tags to be one of the entity types
    if any(type in sparse_entity_types for type in entity_type_set):
        entity_type_set.add(4)
